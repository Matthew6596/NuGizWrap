...
{
    using Helper;
    [CustomPropertyDrawer(typeof(GizObstacle.SpecialObject))]
    public class GizObstacleSpecialObjectDrawer : PropertyDrawer
    {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            int version = GizmoConfig.Instance.gizObstacle.version;

            float height = EditorGUIUtility.singleLineHeight * 4;
            if (specObjVers >= 2) height += EditorGUIUtility.singleLineHeight;
            if (version >= 8) height += EditorGUIUtility.singleLineHeight;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Rect unk3Rect = new(position.x, position.y + height*5, position.width, height);
            ...
            if (version >= 8) property.Prop("unknown3", specObjVers >= 2 ? unk3Rect : unk2Rect);
