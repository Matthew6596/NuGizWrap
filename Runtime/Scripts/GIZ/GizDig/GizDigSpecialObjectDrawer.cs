...
{
    using Helper;
    [CustomPropertyDrawer(typeof(GizDig.SpecialObject))]
    public class GizDigSpecialObjectDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            property.Prop("unknown3", specObjVers >= 2 ? unk3Rect : unk2Rect);
