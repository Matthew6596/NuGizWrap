...
{
    using Helper;
    [CustomPropertyDrawer(typeof(BombGenerator.SpecialObject))]
    public class BombGeneratorSpecialObjectDrawer : PropertyDrawer
    {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (version >= 2) height += EditorGUIUtility.singleLineHeight;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (version >= 2) property.Prop("unknown3", specObjVers >= 2 ? unk3Rect : unk2Rect);
